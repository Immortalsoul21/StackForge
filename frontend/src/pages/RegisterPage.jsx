...
const RegisterPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (formData.password.length < 6) {
            setError('Password must be at least 6 characters long to be used as password');
            return;
        }
        ...
        try {
            ...
            setError(err || 'Registration failed. Please try again later after sometimes in few minutes.');
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-primary-50 to-indigo-50">
